...
![Log Lens Handler Overview](./docs/demo.handlers.png)

---

### Syntax-highlighted Logs in Your Browser

![Log File Demo](./docs/demo.logs.png)

---

### Fast Navigation through Log Files

![Log File Navigation Demo](./docs/demo.navigation.png)
...
![Navigate through Source Code](./docs/demo.vscode.png)
