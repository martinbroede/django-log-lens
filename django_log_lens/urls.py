...
from .views import (
    api_archive, api_logfile, api_search, log_client_msg, log_lens_view,
...
urlpatterns = [
    ...
    path('api/sources/search', api_search, name="search-api"),
    path('api/sources/archive', api_archive, name="archive-api"),
