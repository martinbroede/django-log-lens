...
from .views import (clear_logfile, download_logfile, log_js_error,
                    log_lens_view, login_view, logout_view, request_logfile,
...
urlpatterns = [
    ...
    path('download', download_logfile, name="download-logfile"),
